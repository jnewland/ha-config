 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */var it;function st(t,e,i){const s=t.states[i].attributes.friendly_name||"";if(e.entityNameRegex){const t=e.entityNameRegex.split("/").filter((t=>t));if(2===t.length){const[e,i]=t;return s.replace(new RegExp(e,"g"),i)}}else if(e.entityNameRegexToReplace)return s.replace(new RegExp(e.entityNameRegexToReplace,"g"),e.entityNameReplacement||"");return s}function ot(t,e,i){const s=t.filter((i=>function(t,e,i){const s=t.states[e];try{const t=s.attributes.sonos_group.filter((t=>i.indexOf(t)>-1)),o=(null==t?void 0:t.length)>1,r=o&&t&&t[0]===e;return!o||r}catch(t){return console.error("Failed to determine group master",JSON.stringify(s),t),!1}}(e,i,t))),o=s.map((s=>function(t,e,i,s){const o=t.states[e];try{const r=o.attributes.sonos_group.filter((t=>t!==e&&i.indexOf(t)>-1));return{entity:e,state:o.state,roomName:st(t,s,e),members:rt(r,t,s)}}catch(t){return console.error("Failed to create group",JSON.stringify(o),t),{}}}(e,s,t,i)));return Object.fromEntries(o.map((t=>[t.entity,t])))}function rt(t,e,i){return Object.fromEntries(t.map((t=>[t,st(e,i,t)])))}function nt(t,e,i,s){return at(t)?(null==s?void 0:s.mobileWidth)||i:(null==s?void 0:s.width)||e}function at(t){var e;return innerWidth<((null===(e=t.layout)||void 0===e?void 0:e.mobileThresholdPx)||650)}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */null===(it=window.HTMLSlotElement)||void 0===it||it.prototype.assignedElements;const lt=1,ct=2,dt=t=>(...e)=>({_$litDirective$:t,values:e});class ht{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ut=(t,e)=>{var i,s;const o=t._$AN;if(void 0===o)return!1;for(const t of o)null===(s=(i=t)._$AO)||void 0===s||s.call(i,e,!1),ut(t,e);return!0},mt=t=>{let e,i;do{if(void 0===(e=t._$AM))break;i=e._$AN,i.delete(t),t=e}while(0===(null==i?void 0:i.size))},vt=t=>{for(let e;e=t._$AM;t=e){let i=e._$AN;if(void 0===i)e._$AN=i=new Set;else if(i.has(t))break;i.add(t),gt(e)}};
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function pt(t){void 0!==this._$AN?(mt(this),this._$AM=t,vt(this)):this._$AM=t}function yt(t,e=!1,i=0){const s=this._$AH,o=this._$AN;if(void 0!==o&&0!==o.size)if(e)if(Array.isArray(s))for(let t=i;t<s.length;t++)ut(s[t],!1),mt(s[t]);else null!=s&&(ut(s,!1),mt(s));else ut(this,t)}const gt=t=>{var e,i,s,o;t.type==ct&&(null!==(e=(s=t)._$AP)&&void 0!==e||(s._$AP=yt),null!==(i=(o=t)._$AQ)&&void 0!==i||(o._$AQ=pt))};class ft extends ht{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,i){super._$AT(t,e,i),vt(this),this.isConnected=t._$AU}_$AO(t,e=!0){var i,s;t!==this.isConnected&&(this.isConnected=t,t?null===(i=this.reconnected)||void 0===i||i.call(this):null===(s=this.disconnected)||void 0===s||s.call(this)),e&&(ut(this,t),mt(this))}setValue(t){if((t=>void 0===t.strings)(this._$Ct))this._$Ct._$AI(t,this);else{const e=[...this._$Ct._$AH];e[this._$Ci]=t,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}}
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class bt{constructor(t){this.U=t}disconnect(){this.U=void 0}reconnect(t){this.U=t}deref(){return this.U}}class $t{constructor(){this.Y=void 0,this.q=void 0}get(){return this.Y}pause(){var t;null!==(t=this.Y)&&void 0!==t||(this.Y=new Promise((t=>this.q=t)))}resume(){var t;null===(t=this.q)||void 0===t||t.call(this),this.Y=this.q=void 0}}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const St=t=>!(t=>null===t||"object"!=typeof t&&"function"!=typeof t)(t)&&"function"==typeof t.then;const _t=dt(class extends ft{constructor(){super(...arguments),this._$Cwt=1073741823,this._$Cyt=[],this._$CG=new bt(this),this._$CK=new $t}render(...t){var e;return null!==(e=t.find((t=>!St(t))))&&void 0!==e?e:M}update(t,e){const i=this._$Cyt;let s=i.length;this._$Cyt=e;const o=this._$CG,r=this._$CK;this.isConnected||this.disconnected();for(let t=0;t<e.length&&!(t>this._$Cwt);t++){const n=e[t];if(!St(n))return this._$Cwt=t,n;t<s&&n===i[t]||(this._$Cwt=1073741823,s=0,Promise.resolve(n).then((async t=>{for(;r.get();)await r.get();const e=o.deref();if(void 0!==e){const i=e._$Cyt.indexOf(n);i>-1&&i<e._$Cwt&&(e._$Cwt=i,e.setValue(t))}})))}return M}disconnected(){this._$CG.disconnect(),this._$CK.pause()}reconnected(){this._$CG.reconnect(this),this._$CK.resume()}});
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function wt(t,e,i){return t?e():null==i?void 0:i()}class At extends Z{render(){this.hass=this.main.hass,this.entityId=this.main.activePlayer,this.config=this.main.config,this.mediaControlService=this.main.mediaControlService,this.hassService=this.main.hassService;const t=this.getEntityAttributes(),e=t.sonos_group.length>1;let i=[];return e&&(i=t.sonos_group.map((t=>this.getVolumeTemplate(t,st(this.hass,this.config,t),e,!0)))),I`
      <div style="${this.containerStyle(this.hass.states[this.entityId])}">
        <div style="${this.bodyStyle()}">
          ${wt(!this.main.showVolumes,(()=>t.media_title?I`
 ...
 */class kt extends Z{render(){const t=this.main.config,e=this.main.hass.states[this.group.entity],i=`${e.attributes.media_artist||""} - ${e.attributes.media_title||""}`.replace(/^ - /g,""),s=e.attributes.sonos_group.map((e=>st(this.main.hass,t,e))).join(" + ");return I`
    ...
    `}}t([tt()],kt.prototype,"main",void 0),t([tt()],kt.prototype,"activePlayer",void 0),t([tt()],kt.prototype,"group",void 0),customElements.define("sonos-group",kt);class Pt extends Z{render(){const t=this.main.config;return I`
      <div style="${this.main.buttonSectionStyle()}">
        <div style="${this.main.stylable("title",Ct)}">
    ...
    `}}t([tt()],Pt.prototype,"main",void 0),t([tt()],Pt.prototype,"activePlayer",void 0),t([tt()],Pt.prototype,"groups",void 0),t([tt()],Pt.prototype,"mediaPlayers",void 0),customElements.define("sonos-groups",Pt);class Et extends Z{render(){const t=this.main.activePlayer,e=this.mediaPlayers.filter((e=>e!==t&&this.groups[t].members[e])),i=this.mediaPlayers.filter((e=>e!==t&&!this.groups[t].members[e]));return I`
    ...
    `}getButton(t,e,i){return I`
      <div @click="${t}" style="${this.memberStyle()}" class="hoverable">
        ${i?I`<span style="${Et.nameStyle()}">${i}</span>`:""}
        <ha-icon .icon=${e} style="${Et.iconStyle()}"></ha-icon>
      </div>
    `}membersStyle(){return this.main.stylable("members",{padding:"0",margin:"0",display:"flex",flexDirection:"row",flexWrap:"wrap",justifyContent:"space-between"})}memberStyle(){return this.main.stylable("member",{flexGrow:"1",borderRadius:"var(--sonos-int-border-radius)",margin:"0 0.25rem 0.5rem",padding:"0.45rem",display:"flex",justifyContent:"center",border:"var(--sonos-int-border-width) solid var(--sonos-int-color)",backgroundColor:"var(--sonos-int-background-color)",maxWidth:"calc(100% - 1.4rem)"})}static nameStyle(){return xt({alignSelf:"center",fontSize:"1rem",overflow:"hidden",textOverflow:"ellipsis"})}static iconStyle(){return xt({alignSelf:"center",fontSize:"0.5rem"})}static get styles(){return r`
      .hoverable:hover,
      .hoverable:focus {
        color: var(--sonos-int-accent-color);
        border: var(--sonos-int-border-width) solid var(--sonos-int-accent-color);
      }
    `}}t([tt()],Et.prototype,"main",void 0),t([tt()],Et.prototype,"groups",void 0),t([tt()],Et.prototype,"mediaPlayers",void 0),customElements.define("sonos-grouping-buttons",Et);class Ot extends Z{render(){const t=this.main.config;return I`
      <div style="${this.main.buttonSectionStyle()}">
        <div style="${this.main.stylable("title",Ct)}">
    ...
    `}}t([tt()],Ot.prototype,"main",void 0),t([tt()],Ot.prototype,"groups",void 0),t([tt()],Ot.prototype,"mediaPlayers",void 0),customElements.define("sonos-grouping",Ot);class Tt extends Z{render(){const t=this.getThumbnail();return I`
    ...
    `}}t([tt()],Tt.prototype,"mediaItem",void 0),t([tt()],Tt.prototype,"config",void 0),t([tt()],Tt.prototype,"main",void 0),customElements.define("sonos-media-button",Tt);class It extends Z{constructor(){super(...arguments),this.headerChildStyle={flex:"1","--mdc-icon-size":"1.5rem"}}render(){var t;return this.activePlayer=this.main.activePlayer,this.mediaControlService=this.main.mediaControlService,I`
    ...
    `}headerStyle(){return this.main.stylable("media-browser-header",Object.assign({display:"flex",justifyContent:"space-between"},Ct))}titleStyle(){return this.main.stylable("title",this.headerChildStyle)}playDirStyle(){return this.main.stylable("media-browser-play-dir",Object.assign({textAlign:"left",paddingRight:"-0.5rem",marginLeft:"0.5rem"},this.headerChildStyle))}browseStyle(){return this.main.stylable("media-browse",Object.assign({textAlign:"right",paddingRight:"0.5rem",marginLeft:"-0.5rem"},this.headerChildStyle))}static get styles(){return r`
      .hoverable:focus,
      .hoverable:hover {
        color: var(--sonos-int-accent-color);
      }
    `}}t([tt()],It.prototype,"main",void 0),t([tt()],It.prototype,"mediaBrowser",void 0),t([tt()],It.prototype,"browse",void 0),t([tt()],It.prototype,"currentDir",void 0),customElements.define("sonos-media-browser-header",It);class Mt extends Z{constructor(){super(...arguments),this.mediaItems=[],this.parentDirs=[]}render(){return this.config=this.main.config,this.activePlayer=this.main.activePlayer,this.mediaControlService=this.main.mediaControlService,this.mediaBrowseService=this.main.mediaBrowseService,I`
      <div style="${this.main.buttonSectionStyle({textAlign:"center"})}">
        ...
        ></sonos-media-browser-header>
        ${""!==this.activePlayer&&_t((this.browse?this.loadMediaDir(this.currentDir):this.getAllFavorites()).then((t=>{var e;const i=Mt.itemsWithImage(t),s=i?nt(this.config,"33%","16%",null===(e=this.config.layout)||void 0===e?void 0:e.mediaItem):"100%";return I` <div style="${this.mediaButtonsStyle(i)}">
              ${t.map((t=>I`
                  <sonos-media-button
    ...
    `}browseClicked(){this.parentDirs.length?this.currentDir=this.parentDirs.pop():this.currentDir?this.currentDir=void 0:this.browse=!this.browse}onMediaItemClick(t){t.can_expand?(this.currentDir&&this.parentDirs.push(this.currentDir),this.currentDir=t):t.can_play&&this.playItem(t)}playItem(t){t.media_content_type||t.media_content_id?this.mediaControlService.playMedia(this.activePlayer,t):this.mediaControlService.setSource(this.activePlayer,t.title)}async getAllFavorites(){var t,e,i,s;let o=await this.mediaBrowseService.getAllFavorites(this.mediaPlayers);return this.config.shuffleFavorites?Mt.shuffleArray(o):o=o.sort(((t,e)=>t.title.localeCompare(e.title,"en",{sensitivity:"base"}))),[...(null===(e=null===(t=this.config.customSources)||void 0===t?void 0:t[this.activePlayer])||void 0===e?void 0:e.map(Mt.createSource))||[],...(null===(s=null===(i=this.config.customSources)||void 0===i?void 0:i.all)||void 0===s?void 0:s.map(Mt.createSource))||[],...o]}static createSource(t){return Object.assign(Object.assign({},t),{can_play:!0})}static shuffleArray(t){for(let e=t.length-1;e>0;e--){const i=Math.floor(Math.random()*(e+1));[t[e],t[i]]=[t[i],t[e]]}}static itemsWithImage(t){return t.some((t=>t.thumbnail||t.can_expand))}async loadMediaDir(t){return await(t?this.mediaBrowseService.getDir(this.activePlayer,t):this.mediaBrowseService.getRoot(this.activePlayer))}mediaButtonsStyle(t){return this.main.stylable("media-buttons",Object.assign({padding:"0",display:"flex",flexWrap:"wrap"},!t&&{flexDirection:"column"}))}}t([tt()],Mt.prototype,"main",void 0),t([tt()],Mt.prototype,"mediaPlayers",void 0),t([et()],Mt.prototype,"browse",void 0),t([et()],Mt.prototype,"currentDir",void 0),t([et()],Mt.prototype,"mediaItems",void 0),customElements.define("sonos-media-browser",Mt);class jt{constructor(t,e){this.hass=t,this.hassService=e}async getRoot(t){var e;return(null===(e=(await this.hassService.browseMedia(t)).children)||void 0===e?void 0:e.filter((t=>-1===["media-source://tts","media-source://camera"].indexOf(t.media_content_id||""))))||[]}async getDir(t,e){try{return(await this.hassService.browseMedia(t,e.media_content_type,e.media_content_id)).children||[]}catch(t){return console.error(t),[]}}async getAllFavorites(t){if(!t.length)return[];let e=(await Promise.all(t.map((t=>this.getFavoritesForPlayer(t))))).flatMap((t=>t));return e=this.removeDuplicates(e),e.length?e:this.getFavoritesFromStates(t)}removeDuplicates(t){return t.filter(((t,e,i)=>e===i.findIndex((e=>e.title===t.title))))}async getFavoritesForPlayer(t){var e;const i=null===(e=(await this.hassService.browseMedia(t,"favorites","")).children)||void 0===e?void 0:e.map((e=>this.hassService.browseMedia(t,e.media_content_type,e.media_content_id)));return(i?await Promise.all(i):[]).flatMap((t=>t.children||[]))}getFavoritesFromStates(t){console.log("Custom Sonos Card: found no favorites with thumbnails, trying with titles only");let e=t.map((t=>this.hass.states[t])).flatMap((t=>t.attributes.source_list));return e=[...new Set(e)],e.length||console.log("Custom Sonos Card: No favorites found"),e.map((t=>({title:t})))}}class Rt{constructor(t,e){this.hassService=e,this.hass=t}join(t,e){this.hassService.callSonosService("join",{master:t,entity_id:e})}unjoin(t){this.hassService.callSonosService("unjoin",{entity_id:t})}pause(t){this.hassService.callMediaService("media_pause",{entity_id:t})}prev(t){this.hassService.callMediaService("media_previous_track",{entity_id:t})}next(t){this.hassService.callMediaService("media_next_track",{entity_id:t})}play(t){this.hassService.callMediaService("media_play",{entity_id:t})}shuffle(t,e){this.hassService.callMediaService("shuffle_set",{entity_id:t,shuffle:e})}repeat(t,e){const i="all"===e?"one":"one"===e?"off":"all";this.hassService.callMediaService("repeat_set",{entity_id:t,repeat:i})}volumeDown(t,e){this.hassService.callMediaService("volume_down",{entity_id:t});for(const t in e)this.hassService.callMediaService("volume_down",{entity_id:t})}volumeUp(t,e){this.hassService.callMediaService("volume_up",{entity_id:t});for(const t in e)this.hassService.callMediaService("volume_up",{entity_id:t})}volumeSet(t,e,i){const s=Number.parseInt(e)/100;this.hassService.callMediaService("volume_set",{entity_id:t,volume_level:s});for(const t in i)this.hassService.callMediaService("volume_set",{entity_id:t,volume_level:s})}volumeMute(t,e,i){this.hassService.callMediaService("volume_mute",{entity_id:t,is_volume_muted:e});for(const t in i)this.hassService.callMediaService("volume_mute",{entity_id:t,is_volume_muted:e})}setSource(t,e){this.hassService.callMediaService("select_source",{source:e,entity_id:t})}playMedia(t,e){this.hassService.callMediaService("play_media",{entity_id:t,media_content_id:e.media_content_id,media_content_type:e.media_content_type})}}class Ut{constructor(t){this.hass=t}callSonosService(t,e){this.hass.callService("sonos",t,e)}callMediaService(t,e){this.hass.callService("media_player",t,e)}async browseMedia(t,e,i){return await this.hass.callWS({type:"media_player/browse_media",entity_id:t,media_content_id:i,media_content_type:e})}async getRelatedSwitchEntities(t){const e=await this.hass.callApi("POST","template",{template:"{{ device_entities(device_id('"+t+"')) }}"});return JSON.parse(e.replace(/'/g,'"')).filter((t=>t.indexOf("switch")>-1))}async toggle(t){await this.hass.callService("homeassistant","toggle",{entity_id:t})}}window.customCards=window.customCards||[],window.customCards.push({type:"custom-sonos-card",name:"Sonos Card",description:"Customized media player for your Sonos speakers",preview:!0});class Nt extends Z{render(){this.mediaBrowseService||(this.hassService=new Ut(this.hass),this.mediaBrowseService=new jt(this.hass,this.hassService),this.mediaControlService=new Rt(this.hass,this.hassService));const t=(e=this.config,i=this.hass,e.entities?[...new Set(e.entities)].sort().filter((t=>i.states[t])):Object.values(i.states).filter((t=>t.attributes.sonos_group)).map((t=>t.entity_id)).sort());var e,i;const s=ot(t,this.hass,this.config);return this.determineActivePlayer(s),I`
    ...
    `}}t([tt({attribute:!1})],Nt.prototype,"hass",void 0),t([tt()],Nt.prototype,"config",void 0),t([et()],Nt.prototype,"activePlayer",void 0),t([et()],Nt.prototype,"showVolumes",void 0),customElements.define("custom-sonos-card",Nt);export{Nt as CustomSonosCard};
