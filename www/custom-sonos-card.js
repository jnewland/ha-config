 ...
 */class Pt extends Z{render(){const t=this.main.config,e=this.main.hass.states[this.group.entity],i=`${e.attributes.media_artist||""} - ${e.attributes.media_title||""}`.replace(/^ - /g,""),s=ot(e).map((e=>st(this.main.hass,t,e))).join(" + ");return I`
    ...
    `}}t([tt({attribute:!1})],Bt.prototype,"hass",void 0),t([tt()],Bt.prototype,"config",void 0),t([et()],Bt.prototype,"activePlayer",void 0),t([et()],Bt.prototype,"showVolumes",void 0),customElements.define("custom-sonos-card",Bt);export{Bt as CustomSonosCard};
